...
<head>
    ...
    <script type="text/javascript">
        ...
        var userauthority = [{ "value": "user", "text": "user" }, { "value": "admin", "text": "admin" }];
        function userauthorityformatter(value, rowData, rowIndex) {
            if (value == 0) {
                return;
            }
            for (var i = 0; i < userauthority.length; i++) {
                if (userauthority[i].value == value) {
                    return userauthority[i].text;
                }
            }
        }
        $(function () {
...
<div align="center">
    <table id="mydatagrid">
        ...
        <tr>
            ...
            <th data-options="field:'userauthority',width:66,align:'center',formatter: userauthorityformatter,editor:{type:'combobox',options:{data:userauthority,required:true,editable: false,},}">
                &nbsp;权限
            </th>
        </tr>
        </thead>
